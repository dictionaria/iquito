...
[dc:creator](http://purl.org/dc/terms/creator) | Lev Michael and Christine Beier
[dc:identifier](http://purl.org/dc/terms/identifier) | https://dictionaria.clld.org/contributions/iquito
[dc:license](http://purl.org/dc/terms/license) | https://creativecommons.org/licenses/by/4.0/
[dcat:accessURL](http://www.w3.org/ns/dcat#accessURL) | git@github.com:dictionaria/iquito
[prov:wasDerivedFrom](http://www.w3.org/ns/prov#wasDerivedFrom) | <ol><li><a href="git@github.com:dictionaria/iquito/tree/267c317">git@github.com:dictionaria/iquito 267c317</a></li><li><a href="https://github.com/glottolog/glottolog/tree/v4.3">Glottolog v4.3</a></li></ol>
...
[rdf:ID](http://www.w3.org/1999/02/22-rdf-syntax-ns#ID) | iquito
...
[dc:extent](http://purl.org/dc/terms/extent) | 4128
...
`Derivational_Root` | `string` | 
`Irregular_Plural` | `string` | 
`Irregular_Possessed_Form` | `string` | 
...
[dc:extent](http://purl.org/dc/terms/extent) | 4787
...
`Anthropology_Note` | `string` | 
`Grammar_Note` | `string` | 
`Scientific_Name` | `string` | 
`Sociolinguistics_Note` | `string` | 
...
[dc:extent](http://purl.org/dc/terms/extent) | 988
